    ...
    return (
      <>
        ...
        <input
          ...
          placeholder="Örn: MEB 5. Sınıf Fen"
        />
        ...
        <div className="form-row">
          ...
          <div style={{ flex: 1 }}>
            ...
            <input
              ...
              placeholder="Toplam süre veya puan"
            />
          </div>
        </div>
      </>
    ...
    return (
      <>
        ...
        <input
          ...
          placeholder="Örn: Anlama / Uygulama"
        />
      ...
      <>
        <div style={{ display: 'flex', gap: 8 }}>
          <input
            ...
            placeholder="Yeni çıktı yazıp Enter'a basın"
          />
          <button className="btn small" onClick={this.add}>
            Ekle
          </button>
        </div>
        <ul className="list">
          {(this.props.outcomes || []).map((o, i) => (
            <li key={i}>
              {o} <button className="small-x" onClick={() => this.remove(i)}>x</button>
            </li>
          ))}
        </ul>
      </>
